/**
 *  Copyright (c) 2014 Alexey Andreev.
 *
    ...
    private String format(String message, Object[] params) {
        ...
        while (index < message.length()) {
            ...
            if (paramIndex >= 0 && paramIndex < params.length) {
                sb.append(params[paramIndex] == null ? "null" : params[paramIndex]);
            } else {
                sb.append(message.substring(index, next + 1));
            }
