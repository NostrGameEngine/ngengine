...
import org.ngengine.platform.NGEPlatform;
public class QrViewer extends Container implements GuiControlListener, GuiUpdateListener, MouseListener{
    ...
    protected final QuadBackgroundComponent background = new AspectPreservingQuadBackground();
    ...
    protected void repaint(){
        ...
        if(isSecret()){
            ...
            IconButton showBtn = new IconButton( "icons/outline/eye.svg" );
            IconButton hideBtn = new IconButton("icons/outline/eye-off.svg");
        ...
        if(copyAction!=null){
            IconButton copyBtn = new IconButton( "icons/outline/copy.svg" );
