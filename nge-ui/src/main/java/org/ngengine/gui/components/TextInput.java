...
public class TextInput extends Container implements GuiUpdateListener{
    public static final String ELEMENT_ID = "advInputField";
    protected boolean show = false;
    protected TextField inputField ;
    protected String text;
    protected IconButton showBtn;
    protected IconButton copyBtn  ;
    protected IconButton pasteBtn;
    protected IconButton generateBtn;
    ...
    public TextInput() {
        ...
        rightIconContainer = new Container(new SpringGridLayout(Axis.X, Axis.Y, FillMode.None, FillMode.None),
        ...
        leftIconContainer = new Container(new SpringGridLayout(Axis.X, Axis.Y, FillMode.None, FillMode.None),
    ...
    public void setCopyAction(Consumer<String> action) {
        ...
        copyBtn = new IconButton("icons/outline/copy.svg");
    ...
    public void setPasteAction(Supplier<String> action) {
        ...
        pasteBtn = new IconButton("icons/outline/clipboard.svg");
    ...
    public void setGenerateAction(Supplier<String> action) {
        ...
        generateBtn = new IconButton("icons/outline/dice.svg");
    ...
    protected void repaint(){
        ...
        if(secret){
            ...
            showBtn = new IconButton(!show ? "icons/outline/eye.svg" : "icons/outline/eye-off.svg");
