...
public class MultiPageList<T> extends Container implements GuiUpdateListener, GuiControlListener {
    ...
    protected void callPageChangeListener() {
        if (onPageChange != null) {
            int pageCount = (int)Math.ceil(items.size() / (height / itemHeight))+1;
