...
public class SVGIcon extends IconComponent{

    public SVGIcon(String imagePath, int width, int height) {
        this(imagePath, width, height, new Vector2f(1, 1), 0, 0, 0, false);
        setIconSize(new Vector2f(width, height));
    }
    
    public SVGIcon( String imagePath, int width, int height, Vector2f iconScale,
