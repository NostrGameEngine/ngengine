...
public class IconButton extends Button {
    ...
    public IconButton(String iconPath, String elementId) {
        ...
        IconComponent icon = new SVGIcon(iconPath, iconSize, iconSize);
    ...
    @Override
    public IconButton clone() {
        return (IconButton) super.clone();
    }
