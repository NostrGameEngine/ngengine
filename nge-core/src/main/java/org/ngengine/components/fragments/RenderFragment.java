...
/**
 * A RenderFragment is a component that can receive a RenderManager instance
 * and is called every frame during the render phase.
 * It is used to perform low-level rendering logic, not to update the scene graph, 
 * for that use {@link LogicFragment} or {@link ViewPortFragment}.
 */
public interface RenderFragment extends Fragment{

    /**
     * Receive a RenderManager instance as soon as it is available.
