...
public class FlipBookTexture extends TextureArray{
    ...
    public ColorRGBA getColor(int x, int y, ColorRGBA store) {
        ...
        if (format == Format.RGBA8) {
            store.set(getUByte(data, index) / 255f, getUByte(data, index + 1) / 255f,
                    getUByte(data, index + 2) / 255f, getUByte(data, index + 3) / 255f);
        } else if (format == Format.RGB8) {
            store.set(getUByte(data, index) / 255f, getUByte(data, index + 1) / 255f,
                    getUByte(data, index + 2) / 255f, 1);
            ...
            store.set(data.getFloat(index), data.getFloat(index + 4), data.getFloat(index + 8),
                    data.getFloat(index + 12));
            ...
            store.set(getUByte(data, index + 2) / 255f, getUByte(data, index + 1) / 255f,
                    getUByte(data, index) / 255f, getUByte(data, index + 3) / 255f);
